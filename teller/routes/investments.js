...
module.exports.classifyPlaidFlow = classifyPlaidFlow; // exported for testing (flow vs return classification)
module.exports.computeTWR = computeTWR;               // exported for testing
module.exports.computeXIRR = computeXIRR;             // exported for testing
