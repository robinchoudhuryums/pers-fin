...
const { getPlaidClient, Products, CountryCode } = require("../services/plaid-client");
...
// =========================================================================
// Flows / TWR / XIRR / performance-history — extracted to
// routes/investment-performance.js (this file is the aggregator: it mounts
// the sub-router and re-exports the helpers so every existing import path
// keeps working).
// =========================================================================
const investmentPerformance = require("./investment-performance");
router.use(investmentPerformance);
...
module.exports.computeXIRR = investmentPerformance.computeXIRR;
